...
![Structure of penicillin and site of β-lactamase attack. The thiazolidine ring (1) and β-lactam ring (2) form the core structure. The site of penicillinase (β-lactamase) attack opens the β-lactam ring, converting benzylpenicillin to benzylpenicilloic acid.](images-betalactam1/fig20-1-06.png){#fig-penicillin-structure}
...
![Penicillin-binding protein (PBP) transpeptidation reaction that cross-links bacterial cell wall. The structure for *Staphylococcus aureus* is shown. NAG, *N*-Acetylglucosamine; NAM, *N*-acetylmuramic acid.](images-betalactam1/fig20-2-08.png){#fig-pbp-transpeptidation}
...
![Aminopenicillins: Ampicillin and Amoxicillin structures.](images-betalactam1/fig20-6-25.png){#fig-aminopenicillins}
...
![Penicillins active against gram-negative bacteria.](images-betalactam1/fig20-7-31.png){#fig-antipseudomonal}
