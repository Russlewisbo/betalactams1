...
subtitle: "Chapter 20 — Antimicrobial Pharmacology"
author:
  - name: Ryan K. Shields
  - name: Yohei Doi
date: today
format:
  revealjs:
    ...
    center: true
    transition: slide
    footer: "Penicillins and β-Lactamase Inhibitors"
    smaller: false
...
::: {.notes}
This is part 1 of learning objectives. We'll start with basic science concepts before moving to clinical applications. Allow about 1 minute per slide on average for a 1-hour lecture.
:::
...
::: {.notes}
Part 2 focuses on resistance, classification, pharmacology, and clinical decision-making. These objectives will guide our discussion throughout the lecture.
:::

---

# PART 1: History and Chemistry {background-color="#2c3e50"}
...
:::: {.columns}
::: {.column width="60%"}
- **September 1928**: Alexander Fleming at St. Mary's Hospital, London
...
::: {.column width="40%"}
<!-- IMAGE NEEDED: Fleming's original petri dish or portrait -->
:::
::::
...
![Structure of penicillin showing the thiazolidine ring (1) and β-lactam ring (2). The R group represents the variable side chain.](images/fig20-1-06.png){width="85%"}

::: {.notes}
Point out the three key components: thiazolidine ring (5-membered with sulfur), β-lactam ring (4-membered, essential for activity), and the side chain (R group). The carboxylic acid makes penicillins weak acids.
:::
...
::: {.notes}
This concept is fundamental. All the different penicillin classes arise from different side chain modifications. A bulky side chain near the β-lactam ring provides steric protection against β-lactamases.
:::
...
# PART 2: Mechanism of Action {background-color="#2c3e50"}
...
::: {.callout-important}
**Central Concept**: Penicillins inhibit bacterial cell wall synthesis by binding to penicillin-binding proteins (PBPs)
:::
...
![PBP transpeptidation reaction cross-linking bacterial cell wall. NAG = N-acetylglucosamine; NAM = N-acetylmuramic acid.](images/fig20-2-08.png){width="75%"}

::: {.notes}
Walk through the diagram showing how NAG-NAM chains are cross-linked. Point out that the transpeptidation reaction removes the terminal D-alanine while forming the cross-link.
:::
...
::: {.notes}
This is the key concept. Penicillin structurally mimics the D-Ala-D-Ala substrate. When the PBP tries to bind penicillin, it forms a stable covalent complex instead of completing the reaction. The enzyme is "stuck."
:::
...
# PART 3: Resistance Mechanisms {background-color="#2c3e50"}
...
# PART 4: Classification of Penicillins {background-color="#2c3e50"}
...
**Ureidopenicillins** (piperacillin) — in wide use
...
# PART 5: Pharmacokinetics {background-color="#2c3e50"}
...
# PART 7: β-Lactamase Inhibitors {background-color="#2c3e50"}
...
# PART 8: Clinical Application {background-color="#2c3e50"}
