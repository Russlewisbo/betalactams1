...
## Penicillins and β-Lactamase Inhibitors {background-color="#9B0014"}
...
|  |  |
|------------------------------------|------------------------------------|
| ![](images-betalactam1/dmmunipd_logo.jpeg){width="100"} | ![](images-betalactam1/unipd_seal_white.svg){width="100"} |
...
# PART 1: History and chemistry {background-color="#9B0014"}
...
# PART 2: Mechanism of Action {background-color="#9B0014"}
...
::: {.column width="60%"}
<video src="images-betalactam1/pcn_moa.mov" controls style="width:100%; height:auto;">
...
:::: columns
::: {.column width="60%"}
<video src="images-betalactam1/osmotic.mov" controls style="width:100%; height:auto;">
...
::: aside
This is why penicillins have such a good safety profile. They target a structure (peptidoglycan) that human cells don't have. The selective toxicity ratio is excellent.
:::
...
![](images-betalactam1/transpeptidation.png){fig-align="center"}

::: notes
Walk students through this diagram carefully — it contains the conceptual core of penicillin's mechanism.

**The glycan backbone:** The horizontal chains are the NAG-NAM polymer. NAG (N-acetylglucosamine) and NAM (N-acetylmuramic acid) alternate and are linked by β-1,4-glycosidic bonds. These chains run parallel to the bacterial membrane. Alone, they provide no structural rigidity — that requires the cross-links.

**The peptide stems:** Each NAM residue has a short peptide chain hanging off it — the pentapeptide stem — which terminates in **D-Ala–D-Ala**. These D-amino acids are unique to bacteria; mammals use only L-amino acids, which is a key reason penicillins have such selective toxicity.

**The cross-linking reaction (transpeptidation):** The transpeptidase (a PBP) grabs the terminal D-Ala–D-Ala of one pentapeptide stem. It forms a transient covalent bond with the **penultimate D-Ala**, and in doing so **ejects the terminal D-Ala** as a leaving group. The reactive penultimate D-Ala is then attacked by a free amino group on an adjacent peptide stem, forming the **cross-bridge** that locks the two glycan chains together. One D-alanine is lost for every cross-link formed.

**Why this matters:** Penicillins block only this cross-linking step. The rest of cell wall synthesis — NAG-NAM precursor production, glycan chain polymerization — continues unimpeded. Bacteria keep building structurally unstable, uncrosslinked wall until it can no longer withstand osmotic pressure, and the cell lyses.
:::
...
## Why Penicillins Are Bactericidal

<br>

1.  PBP inhibition stops cross-link formation
2.  Existing autolysins continue degrading old peptidoglycan
3.  New peptidoglycan is weak (not cross-linked)
4.  Cell wall loses integrity
5.  Osmotic pressure causes lysis
6.  **Death is irreversible**

::: notes
The bactericidal effect requires active cell wall synthesis. Dormant bacteria that aren't making new cell wall are "tolerant" to penicillin. This is clinically relevant for treating certain infections.
:::
...
-   **Tolerance**: Bacteria survive but don't grow
    ...
    -   Examples: stationary phase cells, persisters
...
# PART 3: Resistance Mechanisms {background-color="#9B0014"}

::: notes
Understanding resistance mechanisms is essential for appropriate antibiotic selection. We'll cover the four main mechanisms, with emphasis on β-lactamases.
:::
...
::: notes
We'll discuss each mechanism in detail. β-Lactamase production is by far the most common and clinically important. The mechanisms can be additive or synergistic.
:::
...
::: notes
One β-lactamase molecule can destroy thousands of penicillin molecules. This is why even low levels of β-lactamase can cause resistance. The key is the fast deacylation rate compared to PBPs.
:::
...
-   "SPACE" organisms: *Serratia, Pseudomonas, Acinetobacter, Citrobacter, Enterobacter*
-   **NOT inhibited** by clavulanic acid
-   Inhibited by avibactam, relebactam, vaborbactam

::: notes
The SPACE organisms (or ESCPM) have inducible chromosomal AmpC. Exposure to certain β-lactams can induce high-level expression. Cefepime is more stable to AmpC hydrolysis than ceftriaxone.
:::
...
::: notes
The gram-negative outer membrane is an additional barrier. Drugs must pass through porin channels. Loss or modification of porins reduces drug accumulation. This alone usually causes low-level resistance.
:::
...
::: notes
Efflux pumps often work with other mechanisms. In *Pseudomonas*, efflux + β-lactamases + porin loss creates high-level resistance. Efflux pumps can affect multiple drug classes simultaneously.
:::
...
::: notes
This is a critical concept. MRSA produces a novel PBP (PBP2a) with very low affinity for most β-lactams. No amount of β-lactamase inhibitor will help. That's why MRSA requires different antibiotics.
:::
...
::: notes
Understanding this mechanism explains why we need different drugs for MRSA. The newer cephalosporins ceftaroline and ceftobiprole have enhanced binding to PBP2a, which is why they're active against MRSA.
:::

------------------------------------------------------------------------

# PART 4: Classification of Penicillins {background-color="#9B0014"}
...
::: notes
Natural penicillins are still very important. They have the highest intrinsic activity against susceptible organisms. Narrow spectrum can be an advantage (less collateral damage to microbiome).
:::
...
::: notes
These are infections where natural penicillins remain preferred. For syphilis, there is no alternative as effective as penicillin G. Penicillin-allergic patients with syphilis should undergo desensitization.
:::
...
::: notes
The bulky side chain physically blocks β-lactamase access to the β-lactam ring. They're designed specifically for staphylococcal infections. Remember: they don't work against MRSA because MRSA resistance is PBP-mediated, not β-lactamase-mediated.
:::
...
![Aminopenicillins: Ampicillin and Amoxicillin differ only in the hydroxyl group.](images/fig20-6-25.png){width="70%"}
...
::: notes
This is an important practical point. Oral amoxicillin achieves much better levels than oral ampicillin. Unless IV is needed, amoxicillin is the better choice.
:::
...
::: notes
Ticarcillin is no longer manufactured. Piperacillin is only used combined with tazobactam. These drugs have the broadest spectrum of the penicillins but require large doses.
:::
...
![Penicillins active against gram-negative bacteria including Pseudomonas.](images/fig20-7-31.png){width="70%"}

::: notes
Piperacillin has the broadest spectrum of any penicillin. Activity against *P. aeruginosa*, most Enterobacterales, and excellent anaerobic coverage. Always used with tazobactam now.
:::
...
# PART 5: Pharmacokinetics {background-color="#9B0014"}

::: notes
Understanding pharmacokinetics is essential for appropriate dosing. We'll cover absorption, distribution, metabolism, and excretion.
:::
...
::: callout-tip
Amoxicillin has the best oral bioavailability
:::

::: notes
Absorption varies dramatically. This determines which penicillins can be used orally. Amoxicillin is exceptional with 74-92% absorption unaffected by food. Most others should be taken on an empty stomach.
:::
...
::: notes
Memorize that nafcillin doesn't require renal adjustment. For dialysis patients, give the dose after dialysis to avoid drug removal. Extended-spectrum agents like piperacillin require adjustment.
:::
...
# PART 6: Adverse Effects {background-color="#9B0014"}

::: notes
Penicillins are generally safe, but adverse effects do occur. Hypersensitivity is the most important concern.
:::
...
::: notes
We'll discuss each category. Hypersensitivity is the most clinically significant concern. Most other effects are dose-related or specific to certain agents.
:::
...
::: notes
Know these agent-specific effects. The ampicillin rash with infectious mononucleosis is not a true allergy and doesn't predict future reactions. Piperacillin can cause platelet dysfunction with prolonged use.
:::

------------------------------------------------------------------------

# PART 7: β-Lactamase Inhibitors {background-color="#9B0014"}

::: notes
β-Lactamase inhibitors restore penicillin activity against resistant organisms. Understanding their spectrum is essential.
:::
...
|-----------------|--------------|---------------------------|
| Clavulanic acid | Amoxicillin  | Oral (US), IV (elsewhere) |
| Sulbactam       | Ampicillin   | IV                        |
| Tazobactam      | Piperacillin | IV                        |

::: notes
In the US, amoxicillin-clavulanate is only available orally. It's available IV in other countries. Sulbactam has intrinsic activity against *Acinetobacter*. Tazobactam is always used with piperacillin.
:::
...
::: notes
Use this table for quick reference. Note that metallo-β-lactamases (MBLs) are not inhibited by any approved inhibitor. Avibactam has the broadest spectrum, including OXA-48.
:::
...
# PART 8: Clinical Application {background-color="#9B0014"}

::: notes
Let's apply what we've learned to clinical scenarios. We'll work through several cases covering different infection types.
:::
...
::: notes
Pause for discussion. What organisms cause cellulitis? What are the risk factors for MRSA? What's the narrowest effective spectrum?
:::
...
-   **Best choice**: **Nafcillin 2g IV q4h** or **Oxacillin 2g IV q4h**
...
::: notes
This is a medical emergency. What are the first-line agents for meningococcal meningitis?
:::
...
-   **Best choice**: **Penicillin G 4 million units IV q4h**
-   **Alternative**: Ceftriaxone 2g IV q12h
-   **Duration**: 7 days
...
::: notes
Penicillin G remains excellent for meningococcal meningitis. The narrow spectrum is actually an advantage here. Ceftriaxone is often used empirically before organism identification.
:::
...
-   **No adequate alternative** for syphilis
...
# Summary and Key Takeaways {background-color="#9B0014"}
...
1.  Why does MRSA resistance to β-lactams NOT respond to β-lactamase inhibitors?

2.  A patient with KPC-producing *K. pneumoniae* bacteremia—which BLI combinations might be effective?

3.  Why might pip-tazo fail for serious ESBL *E. coli* bacteremia despite susceptibility on testing?

::: notes
Use these for discussion. Q1: MRSA has altered PBP, not β-lactamase. Q2: Ceftazidime-avibactam, meropenem-vaborbactam, imipenem-relebactam. Q3: Inoculum effect, need for higher drug exposure in serious infections.
:::
...
4.  Which penicillin does NOT require dose adjustment in renal failure and why?

5.  A patient needs IV antibiotics for MSSA osteomyelitis. Why is nafcillin preferred over vancomycin?

6.  Why is amoxicillin preferred over ampicillin for oral therapy?

::: notes
Q4: Nafcillin—hepatic elimination. Q5: Better bactericidal activity, better bone penetration, lower treatment failure rates. Q6: Much better oral bioavailability (75-92% vs 30-55%), unaffected by food.
:::
...
-   Bush K, Jacoby GA. Updated functional classification of β-lactamases. *Antimicrobial Agents and Chemotherapy* 2010.
...
::: notes
Allow 5-10 minutes for questions. Be prepared to discuss specific dosing scenarios, cross-reactivity questions, and case-based problems.
:::
